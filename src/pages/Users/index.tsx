          ...
          <CardContent className="flex max-h-none min-h-0 flex-1 flex-col gap-4 overflow-hidden p-4">
            ...
            {loading ? (
              ...
              <div className="min-h-0 flex-1 overflow-auto rounded-md border">
                <div className="grid min-w-[720px] grid-cols-[2fr_2fr_1.5fr_1fr_1fr_88px] border-b bg-muted/40 px-4 py-3 text-xs font-medium uppercase text-muted-foreground">
                  <span>Username</span>
                  <span>Email</span>
                  <span>Phone</span>
                  <span>User Type</span>
